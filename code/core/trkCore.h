...
std::pair<std::vector<int>, std::vector<int>> matchedSimTrkIdxsAndCounts(std::vector<unsigned int> hitidxs, std::vector<unsigned int> hittypes, float thresh=0.75, bool verbose=false);
